...
export default function CategoryDigital() {
  return (
    <div className="container mx-auto mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 justify-between border-2 border-gray-300 rounded-xl overflow-hidden p-3 divide-x-2 divide-gray-300">
